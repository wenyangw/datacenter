...
<body>
<form name="listform" id="listformid" action="<%=request.getContextPath() %>/sysmanage/columnManageAction" method="post">
...
<table width="100%" class="listtable">
	<tr>
		...
		<td class="tdhead" align="center">栏目编号</td>
		<td class="tdhead" align="center">标题</td>
		<td class="tdhead" align="center">显示位置</td>
		<td class="tdhead" align="center">显示方式</td>
		<td class="tdhead" align="center">显示顺序</td>
		<td class="tdhead" align="center">栏目高度</td>
	...
	<%
		...
		if(records != null && records.size() > 0){
			...
			for(int i = 0; i < records.size(); i++){
				...
				%>
				<tr>
				<td class="<%=datatdclass %>" height="20" align="center"><input type="checkbox" name="pkfield" value="<%=cid %>"></td>
				<td class="<%=datatdclass %>" align="center"><%=cid %></td>
				<td class="<%=datatdclass %>" align="center"><%=ctitle %></td>
				<td class="<%=datatdclass %>" align="center"><%=Record.getShowValue(fieldLabels,"showwhere",showwhere)  %></td>
				<td class="<%=datatdclass %>" align="center"><%=Record.getShowValue(fieldLabels,"showtype",showtype) %></td>
				<td class="<%=datatdclass %>" align="center"><%=showorder %></td>
				<td class="<%=datatdclass %>" align="center"><%=cheight %></td>
