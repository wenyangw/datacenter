...
//	}
	public String getPage() {
		...
		if (url != null && url.trim().length() > 0) {
			...
			if (getCurrentPage() != 1) {
				page_str.append("<span style=\"cursor:pointer\" onclick=\""+script_first+"\"><font color=\"blue\">首页</font></span>");
				page_str.append("&nbsp;<span style=\"cursor:pointer\" onclick=\""+script_pre+"\"><font color=\"blue\">上页</font></span>");
			} else {
				page_str.append("首页");
				page_str.append("&nbsp;上页");
			}
			...
			page_str
					.append("&nbsp;" + getCurrentPage() + "/" + getTotalpages());
			if (getCurrentPage() != this.getLastPage()) {
				page_str.append("&nbsp;<span style=\"cursor:pointer\" onclick=\""+script_next+"\"><font color=\"blue\">下页</font></span>");
				page_str.append("&nbsp;<span style=\"cursor:pointer\" onclick=\""+script_last+"\"><font color=\"blue\">尾页</font></span>");
			} else {
				page_str.append("&nbsp;下页");
				page_str.append("&nbsp;尾页");
